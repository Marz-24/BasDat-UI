...
public class InputBarang extends javax.swing.JPanel {
    ...
    private void loadKategoriComboBox() {
        ...
        ResultSet rs = null;
        boolean categoriesFoundInDB = false;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                jComboBox1.addItem(idKategori + " - " + namaKategori);
                categoriesFoundInDB = true;
            }

            if (!categoriesFoundInDB) {
                System.out.println("No categories found in database, setting up default categories.");
                setupDefaultCategories();
            }
    ...
    private void saveBarang() {
        ...
        try {
            ...
            pstmtKategori.close(); // Tutup setelah digunakan
            ...
            pstmtProduk.close(); // Tutup setelah digunakan
            ...
            pstmtSupplier.close(); // Tutup setelah digunakan
            ...
            try {
                // Pastikan semua PreparedStatement ditutup
                if (conn != null) {
