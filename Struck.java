...
import marketplace.MainMarketplace;
import static marketplace.MainMarketplace.main;
import static marketplace.Marketplace.main;
...
public class Struck extends javax.swing.JPanel {
    ...
    public void setTransactionData(List<ItemTransaksi> listBarang, String idPembeli, String idKasir) {
        this.listBarang = listBarang != null ? new ArrayList<>(listBarang) : new ArrayList<>();
        this.idPembeli = idPembeli;
        this.idKasir = idKasir;
        
        // Ambil nama pembeli dari database
        this.namaPembeli = DatabaseConnection.getNamaPembeli(idPembeli);
    ...
    try {
        ...
        // Generate reference number dan set header info
        ...
        // Populate table dan hitung total
        ...
        labelStatus.setText("MENUNGGU PEMBAYARAN"); // Tambahkan status default
    ...
    try {
        ...
        boolean success = DatabaseConnection.simpanTransaksiMultiple(listBarang, idPembeli, idKasir, totalBelanja, kembalian);
    ...
    private void transaksiBaruButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transaksiBaruButtonActionPerformed
        ...
        // Kembali ke halaman jual barang
